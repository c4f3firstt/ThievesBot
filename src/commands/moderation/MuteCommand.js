...
module.exports = class MuteCommand extends Command {
  ...
  async run(ctx) {
    ...
    if (!timeStr[1]) return ctx.send("Você não especificou o tempo do mute. Lembre que o comando funciona assim: `!mute @user Brigou no server | 12m 5d`")
    ...
    user.roles.add(this.client.config.roles.muted_role)
